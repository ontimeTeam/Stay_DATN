    ...
    return (
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            <ImageBackground source={SUBTRACT} style={{
                ...
                <Text style={styles.txtContent}>Bạn đã thanh toán thành công {roomType}</Text>
                ...
                <View style={styles.itemHotel}>
                    <Image source={{ uri: hotelImage }} style={styles.imgHotel} />
                    <View style={styles.itemRight}>
                        <Text style={styles.txtNameHotel} numberOfLines={2} ellipsizeMode='tail'>{hotelName}</Text>
                        <View style={styles.viewStar}>
                            <Image source={ICON_STAR_TRON} style={styles.iconStar} />
                            <Text style={styles.txtStar}>{hotelRates}</Text>
                            <Text style={styles.txtReview}>({formatNumber(hotelViews)} lượt xem)</Text>
                        </View>
                        <Text style={styles.txtAddress} numberOfLines={2} ellipsizeMode='tail'>{hotelAddress}</Text>
                    </View>
                </View>
