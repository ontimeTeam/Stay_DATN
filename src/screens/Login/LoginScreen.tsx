import { StyleSheet, Text, View, ScrollView, TextInput, Pressable, Image, Alert, Dimensions, ToastAndroid, GestureResponderEvent } from 'react-native'
    ...
    const handleLogin = async () => {
        try {
            ...
            const response = await fetch('https://stayapi-production.up.railway.app/api/auth/login', {
                ...
                body: JSON.stringify({ phone: phoneNumber, password: valuePassword })
            })
